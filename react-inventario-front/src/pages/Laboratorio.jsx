...
const Laboratorio = () => {
    ...
    useEffect(()=>{
        LaboratorioService.getAll().then(
            (res)=>{
                setData(res);
    ...
    const createUpdateData = (e) =>{
        e.preventDefault();
        if(dataId > 0){
            LaboratorioService.updateOne(dataId,newData).then(
                (res)=>{
                    setRefreshData(true);
                    setNewData({
                        descripcion:"",
            ...
            LaboratorioService.setNew(newData).then(
                (res)=>{
                    console.log(res)
                    setRefreshData(true)
                    setNewData({
    ...
    const editData = (cod) =>{
        LaboratorioService.getOne(cod).then(
            (res)=>{
                setNewData({
    ...
    const deleteData = (cod) =>{
        LaboratorioService.deleteOne(cod).then(
            (res)=>{
                setRefreshData(true);
                setNewData({
                    descripcion:"",
